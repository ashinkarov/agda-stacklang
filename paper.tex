...
the program typechecks, the property is guaranteed to hold.  If we can
extend our existing language with dependent types (for verification
...
To keep presentation as simple as possible, we have
...
This entire paper is a literate Agda script: all Agda code is typechecked
and all the examples are run while generating the paper.
