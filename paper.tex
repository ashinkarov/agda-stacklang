...
%%% FIXME I am didnt update publishing rights yet, as I am waiting for
%%% the university to comeback with the payment instructions for open access.
...
%%%
%%% The following is specific to GPCE '21 and the paper
%%% 'Extracting the Power of Dependent Types'
%%% by Artjoms Šinkarovs and Jesper Cockx.
%%%
\setcopyright{rightsretained} % XXX ENSURE THAT THIS VALUE IS CORRECT!!!
\acmPrice{15.00}
\acmDOI{10.1145/3486609.3487201}
\acmYear{2021}
\copyrightyear{2021}
\acmSubmissionID{splashws21gpcemain-p18-p}
