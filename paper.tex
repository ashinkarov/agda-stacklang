...
reflection.
This allows us to enjoy simplicity of writing progams
...
in order to enforce static propeties of the embedded programs.
...
This sugests that you are now empowered to apply the proposed
technique tp verify code in any language.
